...
classdef GenericColourMap < hdng.colour_mapping.ColourMap
    ...
    methods (Static)
        ...
        function result = twilight_27(zero_opacity_midpoint)
        
            if ~exist('zero_opacity_midpoint', 'var')
                zero_opacity_midpoint = false;
            end

            if zero_opacity_midpoint
                midpoint_opacity = 0;
            else
                midpoint_opacity = 1;
            end
            ...
            result = hdng.colour_mapping.GenericColourMap.define_gradient({
                ...
                {[137, 216, 236, 255]}, ...
                {[199, 243, 248, 255]}, ...
                {[234, 239, 241, 255 * midpoint_opacity], 'constant', struct('value', 0)}, ...
                {[255, 231, 196, 255]}, ...
                {[254, 166, 118, 255]}, ...
                {[229, 105,  51, 255]}, ...
                {[146,  38,  42, 255], 'max'}, ...
