...
classdef GridSpatialIndex < geospm.SpatialIndex
    ...
    methods (Access=protected)
        ...
        function result = define_clone_arguments(obj, row_selection, column_selection)
            ...
            result = define_clone_arguments@geospm.SpatialIndex(obj, row_selection, column_selection);
            
            result.u = obj.u(row_selection);
            result.v = obj.v(row_selection);
            result.w = obj.w(row_selection);
        ...
        function result = create_clone_from_arguments(~, arguments)
            ...
            result = geospm.GridSpatialIndex(arguments.u, ...
                                             arguments.v, ...
                                             arguments.w, ...
                                             arguments.x, ...
                                             arguments.y, ...
