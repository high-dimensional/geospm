...
data_columns = {
    ...
    'is_female', 'age', 'subjective_health_score', 'ndiox_pollution_2010', ...
};
...
[data, spatial_index] = geospm.load_data(file_path, ...
...
parameters.define_grid(...
    spatial_index, ...
    'min_location', spatial_index.min_xy, ... %[388000, 269000], ...
    'max_location', spatial_index.max_xy, ... %[423000, 304000], ...
